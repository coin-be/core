...
const QString BITCOIN_IPC_PREFIX("coinbe:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/coinbe-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/coinbe-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/coinbe-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click coinbe: links
...
//
// OSX-specific way of handling coinbe: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in coinbe: URIs
