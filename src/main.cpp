...
#if defined(NDEBUG)
# error "Coinbe cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Coinbe Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Coinbe also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Coinbe also requires low S in sigs
